...
class CustomTextFieldMin extends StatefulWidget {
  ...
  _CustomTextFieldMinState createState() => _CustomTextFieldMinState();
}

class _CustomTextFieldMinState extends State<CustomTextFieldMin> {
