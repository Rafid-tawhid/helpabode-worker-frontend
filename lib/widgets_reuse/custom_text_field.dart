...
class CustomTextFieldChat extends StatefulWidget {
  ...
  _CustomTextFieldChatState createState() => _CustomTextFieldChatState();
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        style: interText(16, Colors.black, FontWeight.w500).copyWith(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: interText(16, Colors.black, FontWeight.w400),
