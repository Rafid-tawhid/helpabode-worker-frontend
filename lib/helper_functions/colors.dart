...
class myColors {
  static Color grey = const Color(0xff535151);
  static Color devider = const Color(0xffF6F6F6);
  static Color greyBg = const Color(0xffF7F7F7);
  static Color greyBtn = const Color(0xffE9E9E9);
  static Color greyTxt = const Color(0xffAAA6A6);
  static Color greyServiceBg = const Color(0xffE9E9E9);
  static Color errorRed = const Color(0xffFFBDBD);
  static Color green = const Color(0xff008951);
  static Color green10 = const Color(0xFFDFF2E1);
  static Color greenLight = const Color(0xffDEF0E8);
  static Color orange = const Color(0xffFAA71A);
