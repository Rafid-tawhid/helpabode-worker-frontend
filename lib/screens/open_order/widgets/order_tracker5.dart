...
class OrderTracker5 extends StatefulWidget {
  ...
  @override
  State<OrderTracker5> createState() => _OrderTracker4State();
}

class _OrderTracker4State extends State<OrderTracker5> {
  @override
  void initState() {
    super.initState();
  }
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                thisIndex !=
                        widget.dataList
                            .length // Prevents indicator for the last item
                    ? SizedBox(
                        width: 3.3,
                        height: 50,
                        child: RotatedBox(
                    ...
                    : SizedBox.shrink(), // Hide indicator for the last item
              ],
            ),
            const SizedBox(
              width: 12,
