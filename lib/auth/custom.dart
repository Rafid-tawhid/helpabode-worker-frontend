...
class CustomTextFieldAjira extends StatefulWidget {
  ...
  _CustomTextFieldAjiraState createState() => _CustomTextFieldAjiraState();
}

class _CustomTextFieldAjiraState extends State<CustomTextFieldAjira> {
